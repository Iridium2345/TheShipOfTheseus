...
public class TSOT_QuickRebuild extends BaseShipSystemScript{
    ...
    public static final Color JITTER_COLOR = new Color(205,205,255,45);

	public static final Color JITTER_UNDER_COLOR = new Color(255,255,255,70);
