...
public class QuantizedHull extends BaseHullMod{
    ...
    private static final float SOFT2HARD_RATE = .3f;
    
    private static final float BASEARMOR = .05f;
	...
	public void advanceInCombat(ShipAPI ship, float amount) {
        ...
        final float armor = hardFlux2Armor(tracker.getHardFlux() + tracker.getMaxFlux() * BASEARMOR);
        ...
        if(player){
            engine.maintainStatusForPlayerShip(this,
                    ...
                    String.format("伤害减免 %.1f%% 装甲 %f", takenMult * 100 , armor),
                    false
            );
        }
	}
